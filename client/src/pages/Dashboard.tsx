    ...
    <div className="min-h-screen bg-white">
      <div className="flex flex-col gap-8 p-6">
        ...
        <div className="text-center space-y-4">
          <div className="inline-flex items-center px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full text-white font-medium shadow-lg text-[26px] pt-[16px] pb-[16px] pl-[28px] pr-[28px]">
