        ...
        <CardContent>
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-semibold">Nenhuma conta bancária cadastrada</h3>
              <p className="text-muted-foreground max-w-md">
                Cadastre suas contas bancárias para controlar saldos e movimentações financeiras
              </p>
            </div>
            <Button className="gap-2">
              <Plus className="h-4 w-4" />
...
export default ContasBancariasCadastro;