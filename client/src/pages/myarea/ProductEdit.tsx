                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Digite o código EAN" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Produto ativo aparece nos canais de venda
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Digite os bullet points (um por linha)..."
                        className="min-h-[100px]"
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
                      Separe cada bullet point com uma nova linha
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
