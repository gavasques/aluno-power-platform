            ...
            <CardContent>
              <Tabs defaultValue="suppliers" className="w-full">
                <TabsList className="grid w-full grid-cols-2">
                  ...
                  <TabsTrigger value="legacy">Dados Legados</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="suppliers" className="mt-6">
                  ...
                  {!productId && (
                    <div className="text-center py-8 text-gray-500">
                      ...
                      <p>Salve o produto primeiro para gerenciar fornecedores</p>
                      <p className="text-sm">O gerenciamento de fornecedores ficará disponível após criar o produto</p>
                    </div>
                  )}
                </TabsContent>
                  ...
                  <div className="space-y-6">
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                      <p className="text-sm text-yellow-800">
                        <strong>Atenção:</strong> Estes campos são mantidos para compatibilidade com dados antigos. 
                        Use a aba "Fornecedores" para gerenciar múltiplos fornecedores.
                      </p>
                    </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Fornecedor (Legacy)</FormLabel>
                          <Select 
