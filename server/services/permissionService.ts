...
export class PermissionService {
  ...
  static async initializeFeatures() {
    const features = [
      ...
      { code: 'tools.access', name: 'Acesso às Ferramentas', category: 'Ferramentas', sortOrder: 1 },
      { code: 'tools.image_upscale', name: 'Upscale de Imagem', category: 'Ferramentas', sortOrder: 2 },
      { code: 'tools.background_removal', name: 'Remover Background', category: 'Ferramentas', sortOrder: 3 },
      { code: 'tools.picsart_background_removal', name: 'Remover de Fundo PRO', category: 'Ferramentas', sortOrder: 4 },
      ...
      { code: 'agents.amazon_listing', name: 'Amazon Listing Optimizer', category: 'Agentes', sortOrder: 2 },
      { code: 'agents.html_descriptions', name: 'Gerador de Descrições HTML', category: 'Agentes', sortOrder: 3 },
      { code: 'agents.bullet_points', name: 'Gerar Bullet Points', category: 'Agentes', sortOrder: 4 },
      { code: 'agents.main_image_editor', name: 'Editar Imagem Principal', category: 'Agentes', sortOrder: 5 },
      { code: 'agents.lifestyle_model', name: 'Editar Imagem - Lifestyle com Modelo', category: 'Agentes', sortOrder: 6 },
      { code: 'agents.infographic_editor', name: 'Editar Fotos Infográficos', category: 'Agentes', sortOrder: 7 },
      { code: 'agents.advanced_infographic', name: 'Gerador Avançado de Infográficos', category: 'Agentes', sortOrder: 8 },
      { code: 'agents.customer_service', name: 'Amazon Customer Service Email', category: 'Agentes', sortOrder: 9 },
      { code: 'agents.negative_reviews', name: 'Amazon Negative Reviews Response', category: 'Agentes', sortOrder: 10 },
      ...
      { code: 'myarea.products', name: 'Meus Produtos', category: 'Minha Área', sortOrder: 3 },
      { code: 'myarea.imported_products', name: 'Produtos Importados', category: 'Minha Área', sortOrder: 4 },
      { code: 'myarea.international_suppliers', name: 'Fornecedores Internacionais', category: 'Minha Área', sortOrder: 5 },
      { code: 'myarea.sales_channels', name: 'Canais de Venda', category: 'Minha Área', sortOrder: 6 },
      { code: 'myarea.import_crm', name: 'CRM de Importações', category: 'Minha Área', sortOrder: 7 },
      { code: 'myarea.materials', name: 'Meus Materiais', category: 'Minha Área', sortOrder: 8 },
      { code: 'myarea.brands', name: 'Minhas Marcas', category: 'Minha Área', sortOrder: 9 },
      { code: 'myarea.subscriptions', name: 'Minhas Assinaturas', category: 'Minha Área', sortOrder: 10 },
      { code: 'myarea.profile', name: 'Meu Perfil', category: 'Minha Área', sortOrder: 11 },
      { code: 'myarea.import_export', name: 'Importar/Exportar', category: 'Minha Área', sortOrder: 12 },
      
      // Simuladores e Outros
      { code: 'simulators.simples_nacional', name: 'Simples Nacional', category: 'Simuladores', sortOrder: 1 },
      { code: 'simulators.simples_nacional_completo', name: 'Simples Nacional Completo', category: 'Simuladores', sortOrder: 2 },
      { code: 'simulators.importacao_simples', name: 'Importação Simplificada', category: 'Simuladores', sortOrder: 3 },
      { code: 'simulators.importacao_formal', name: 'Importação Formal', category: 'Simuladores', sortOrder: 4 },
      { code: 'simulators.importacao_formal_fixed', name: 'Importação Formal Aprimorado', category: 'Simuladores', sortOrder: 5 },
      { code: 'simulators.investimentos_roi', name: 'Retorno sobre Investimento', category: 'Simuladores', sortOrder: 6 },
      { code: 'simulators.marketplace_comparison', name: 'Comparador de Marketplaces', category: 'Simuladores', sortOrder: 7 },
      { code: 'simulators.access', name: 'Acesso aos Simuladores', category: 'Simuladores', sortOrder: 8 },
